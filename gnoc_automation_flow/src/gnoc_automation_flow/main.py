...
def kickoff(summary, description, priority, segment, product):
    ...
    result = gnoc_identification_flow.kickoff(inputs={"summary": summary, "description": description, "priority": priority, "segment": segment, "product": product})
    print("******************************************")
